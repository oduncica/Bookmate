...
import { getBookSuggestions, likeBook, dislikeBook, readBook, getMatches } from '../controllers/matchController.js';
...
router.post('/read/:bookId', protectedRoute, readBook); //Ajouter à la categorie lu de la bibliothèque
